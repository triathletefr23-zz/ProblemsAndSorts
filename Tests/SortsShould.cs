...
namespace Tests
{
    ...
    public class SortsShould
    {
        ...
        public void ReturnSortedDefaultArrayByQuickSort()
        {
            var result = Sorts.QuickSort(defaultArray);
        ...
        [TestMethod]
        [TestCategory("QuickSort")]
        public void ReturnSortedDoublesArrayByQuickSort()
        {
            var result = Sorts.QuickSort(arrayWithDoubles);
        ...
        [TestMethod]
        [TestCategory("QuickSort")]
        public void ReturnSortedTwoElementArrayByQuickSort()
        {
            var result = Sorts.QuickSort(twoElementsArray);
        ...
        [TestMethod]
        [TestCategory("QuickSort")]
        public void ReturnSortedOneElementArrayByQuickSort()
        {
            var result = Sorts.QuickSort(oneElementArray);
